-- migrate:up
-- ============================================================
-- Patch: profiles RLS + HR 모듈 (employees/attendance/payrolls/leaves/salary_items)
-- Source: supabase/fix-profiles-rls-hr.sql
-- ============================================================
...
-- migrate:down
-- HR 모듈 테이블/정책을 모두 제거.
-- 데이터 손실: 이 down 실행 시 employees/attendance/payrolls/leaves/salary_items 데이터 영구 삭제.
-- 운영 환경에서는 백업 후에만 실행할 것.
...
DROP TABLE IF EXISTS salary_items CASCADE;
