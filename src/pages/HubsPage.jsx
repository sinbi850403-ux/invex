  ...
  return (
    <div>
      ...
      <div className="hub-grid">
        ...
        <HubCard icon="⚖️" title="미수·미지급 정산" desc="채권과 채무 현황을 점검합니다." nav="accounts" color="#d97706" />
  ...
  return (
    <div>
      ...
      <div className="hub-grid">
        ...
        <HubCard icon="🛡️" title="권한 관리" desc="역할별 접근 권한을 설정합니다." nav="roles" color="#7c3aed" />
  ...
  return (
    <div>
      ...
      <div className="hub-grid">
        ...
        <HubCard icon="⏱️" title="근태 관리" desc="출퇴근과 근무 시간을 관리합니다." nav="attendance" color="#16a34a" />
        <HubCard icon="💵" title="급여 계산" desc="급여와 공제 항목을 계산합니다." nav="payroll" color="#d97706" />
        <HubCard icon="🏖️" title="휴가·연차 관리" desc="연차 잔여와 휴가 요청 흐름을 관리합니다." nav="leaves" color="#7c3aed" />
