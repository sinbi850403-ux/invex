 ...
 * @updated 2026-05-05 Seoul region (ap-northeast-2) — force rebuild v2
...
// 서울 리전(ap-northeast-2) 프로젝트 — 반드시 .env 또는 Vercel 환경변수에 설정
// [SECURITY] 하드코딩된 폴백 키 제거 — VITE_SUPABASE_URL, VITE_SUPABASE_ANON_KEY 필수
